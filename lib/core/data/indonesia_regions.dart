// Dataset wilayah Indonesia: Provinsi → Kota/Kabupaten
// Data ini digunakan untuk pemilihan wilayah pejabat dan pelaporan.


class IndonesiaRegions {
  IndonesiaRegions._();

  /// Daftar seluruh nama provinsi di Indonesia
  ...
  static const Map<String, List<String>> kotaByProvinsi = {
    'Aceh': [
      'Kota Banda Aceh', 'Kota Langsa', 'Kota Lhokseumawe', 'Kota Sabang',
      'Kota Subulussalam', 'Kab. Aceh Barat', 'Kab. Aceh Barat Daya',
    ...
    'Kepulauan Riau': [
      ...
      'Kab. Anambas', 'Kab. Bintan', 'Kab. Karimun',
    ...
    'Gorontalo': [
      'Kota Gorontalo',
      'Kab. Bone Bolango', 'Kab. Gorontalo', 'Kab. Gorontalo Utara',
      'Kab. Pohuwato',
    ],
    'Sulawesi Tengah': [
      'Kota Palu',
    ...
    'Papua Pegunungan': [
      ...
      'Kab. Nduga', 'Kab. Pegunungan Bintang', 'Kab. Puncak', 'Kab. Puncak Jaya',
      'Kab. Tolikara', 'Kab. Yahukimo', 'Kab. Yalimo',
    ],
  };

  /// Ambil daftar kota/kabupaten berdasarkan nama provinsi
